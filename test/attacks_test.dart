  ...
  group('Attacks', () {
    ...
    test('knight attacks', () {
      ...
      expect(
        ...
        equals(
          SquareSet.fromList([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa0000000, 0x0]),
        ),
      );
      expect(
        knightAttacks(s(255), Side.sente),
        equals(
          SquareSet.fromList([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40000000, 0x0]),
        ),
      );
    ...
    test('silver attacks', () {
      ...
      expect(
        ...
        equals(
          SquareSet.fromList([0xa0000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        ),
      );
      expect(
        silverAttacks(s(15), Side.sente),
        equals(
          SquareSet.fromList([0x40000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        ),
      );
      expect(
      ...
      expect(
        ...
        equals(
          SquareSet.fromList([0xe0000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        ),
      );
      expect(
        silverAttacks(s(15), Side.gote),
        equals(
          SquareSet.fromList([0xc0000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        ),
      );
      expect(
    ...
    test('gold attacks', () {
      ...
      expect(
        ...
        equals(
          SquareSet.fromList([0x4000a000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        ),
      );
      expect(
        goldAttacks(s(15), Side.sente),
        equals(
          SquareSet.fromList([0x80004000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        ),
      );
      expect(
      ...
      expect(
        ...
        equals(
          SquareSet.fromList([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa000e000]),
        ),
      );
      expect(
        goldAttacks(s(255), Side.sente),
        equals(
          SquareSet.fromList([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4000c000]),
        ),
      );
      ...
      expect(
        ...
        equals(
          SquareSet.fromList([0xe000a000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        ),
      );
      expect(
        goldAttacks(s(15), Side.gote),
        equals(
          SquareSet.fromList([0xc0004000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0]),
        ),
      );
      expect(
      ...
      expect(
        ...
        equals(
          SquareSet.fromList([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xa0004000]),
        ),
      );
      expect(
        goldAttacks(s(255), Side.gote),
        equals(
          SquareSet.fromList([0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x40008000]),
        ),
      );
    });
    ...
    test('chushogi pieces', () {
      expect(
        attacks(
          const Piece(role: Role.leopard, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.copper, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.elephant, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.chariot, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.tiger, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.phoenix, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.kirin, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.sidemover, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.verticalmover, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.queen, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.lion, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.gobetween, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.promotedpawn, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.ox, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.stag, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.boar, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.falcon, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.prince, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.eagle, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.whale, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.whitehorse, side: Side.sente),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.copper, side: Side.gote),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.elephant, side: Side.gote),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.tiger, side: Side.gote),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.promotedpawn, side: Side.gote),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.falcon, side: Side.gote),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.eagle, side: Side.gote),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.whale, side: Side.gote),
          s(75),
          SquareSet.empty,
        ),
        equals(
      ...
      expect(
        attacks(
          const Piece(role: Role.whitehorse, side: Side.gote),
          s(75),
          SquareSet.empty,
        ),
        equals(
